...
public class MenuScreen extends Pane {
    ...
    public MenuScreen(Game game) {
        ...
        exitButton.getStyleClass().addAll("button", "button--round");


        String path = """
                M62.666,32.316L57.758,21.53c-0.457-1.007-1.646-1.449-2.648-0.992c-1.006,0.457-1.45,1.644-0.992,2.648l3.365,7.397
                ...
                """ + """
                M51.583,47.577c-1.104,0-2,0.895-2,2v8.006h-11V15.269c0-1.722-0.81-3.25-2.445-3.795L24.536,7.583h25.047v9.994
                ...
                """ + "M30.583,47.577c0.553,0,1-0.447,1-1v-6c0-0.553-0.447-1-1-1s-1,0.447-1,1v6C29.583,47.13,30.03,47.577,30.583,47.577z";


        SVGPath svgIconExit = new SVGPath();
        svgIconExit.setContent(path);
        svgIconExit.setScaleX(0.6);
        svgIconExit.setScaleY(0.6);
        svgIconExit.setFill(Color.WHITE);

        exitButton.setGraphic(svgIconExit);
        exitButton.layoutXProperty().bind(widthProperty().subtract(100));
